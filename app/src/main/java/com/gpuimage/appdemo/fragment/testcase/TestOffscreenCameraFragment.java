 ...
 */
public class TestOffscreenCameraFragment extends BaseFragment {
    protected static final String TAG = TestOffscreenCameraFragment.class.getSimpleName();
    @BindView(R.id.topbar) QMUITopBar mTopBar;
    @BindView(R.id.take_picture)
    protected Button mTakePicBtn;
    ...
    public static ItemDescription mItemDescription = new ItemDescription(TestOffscreenCameraFragment.class,
            "offscreen camera", R.mipmap.icon_tabbar_lab);
